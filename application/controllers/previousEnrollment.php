...
class previousEnrollment extends Application {
	...
	if(logged_in()) {
  	...
  	$crud->unset_add_fields(array('status','cancelNotes','checkedIn','userCancel','noshow','invoiceID','reminderEmailSent','enrollmentTimestamp','enrollmentUser','emailStudent'));
...
$crud->unset_delete();
    ...
    $this->load->view('previous_enrollments', $output);
