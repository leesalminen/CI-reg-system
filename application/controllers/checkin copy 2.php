...
class Checkin extends CI_Controller {
	...
	function index()
	{
		...
		$sql = 'SELECT billing.billingcontact,student.firstname,student.lastname,class_titles.classname, enrollment.id AS enrollmentid, enrollment.checkedIn, enrollment.userCancel,enrollment.noshow,class_schedule.startdate,company.companyname FROM enrollment
...
LEFT JOIN company as company ON company.id = student.companyid
WHERE class_schedule.cancelled = "No"
AND enrollment.userCancel = "0"
AND enrollment.noshow = "0"
AND startdate = "' .$today. '"';
