...
$companyName = $result->row();
	   ...
	   if($arr->regType == 'Coupons') { $regType = 'CPN'; } elseif ($arr->regType == 'All Access Pass') { $regType = 'AAP'; } elseif ($arr->regType == 'MOA' ) { $regType = 'MOA'; } elseif($arr->regType == 'SA Voucher') { $regType = 'SAV'; } else { $regType = '';}
